...
{
    class SSVDataWorkbookExporter : CoreWorkbookExporter<SummarizedSSUResults>
    {
        public SSVDataWorkbookExporter(IExcelExporter excelExporter, SummaryDataExporter summaryDataExporter) : base(excelExporter, summaryDataExporter)
        {
        ...
        {
            return accrualType.RawSSVValues;
        }
    }
}
