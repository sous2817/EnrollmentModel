...
{
    class RandomizationDataWorkbookExporter : CoreWorkbookExporter<SummarizedAccrualResults>
    {
        public RandomizationDataWorkbookExporter(IExcelExporter excelExporter, SummaryDataExporter summaryDataExporter) : base(excelExporter, summaryDataExporter)
        {
        }
        ...
        {
            return accrualType.RawRandomizationValues;
        }
    }
}
